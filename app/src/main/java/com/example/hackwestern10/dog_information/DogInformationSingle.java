...
public class DogInformationSingle {
    ...
    public DogInformationSingle(String weight_male, String weight_female, String height_male, String height_female, String life_expectancy, String nutrition, String exercise) {
